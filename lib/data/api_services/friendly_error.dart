  ...
  static String getMessage(dynamic error) {
    try {
      ...
      if (error is DioException) {
        ...
        switch (statusCode) {
          case 400:
            return extractMessage(data) ?? 'Invalid request. Please check your input.';
          case 401:
          ...
          case 403:
            return extractMessage(data) ?? 'You do not have permission to perform this action.';
          case 404:
            return extractMessage(data) ?? 'The requested resource was not found.';
          case 409:
            return extractMessage(data) ?? 'Request conflicts with existing data.';
          case 422:
            return extractMessage(data) ?? 'Validation error. Please check your input.';
          case 500:
            return 'Server error. Please try again later.';
          case 503:
            return 'Server is temporarily unavailable.';
          default:
            return extractMessage(data) ?? 'Something went wrong. Please try again.';
        }
      }
